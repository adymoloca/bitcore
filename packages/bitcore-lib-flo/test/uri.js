...
describe('URI', function() {
  ...
  it('parses uri strings correctly (test vector)', function() {
    ...
    uri = URI.parse('flocoin:');
    expect(uri.address).to.be.undefined;
    expect(uri.amount).to.be.undefined;
    expect(uri.otherParam).to.be.undefined;

    uri = URI.parse('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
    uri.address.should.equal('LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
    expect(uri.amount).to.be.undefined;
    expect(uri.otherParam).to.be.undefined;

    uri = URI.parse('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=123.22');
    uri.address.should.equal('LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
  ...
  it('URIs can be validated statically (test vector)', function() {
    URI.isValid('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3').should.equal(true);
    URI.isValid('flocoin:mkYY5NRvikVBY1EPtaq9fAFgquesdjqECw').should.equal(true);

    URI.isValid('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2')
                .should.equal(true);
    URI.isValid('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&other=param')
                .should.equal(true);
    URI.isValid('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&req-other=param',
                ['req-other']).should.equal(true);
    URI.isValid('flocoin:mmrqEBJxUCf42vdb3oozZtyz5mKr3Vb2Em?amount=0.1&' +
                'r=https%3A%2F%2Ftest.bitpay.com%2Fi%2F6DKgf8cnJC388irbXk5hHu').should.equal(true);

    URI.isValid('flocoin:').should.equal(false);
    URI.isValid('flocoin:badUri').should.equal(false);
    URI.isValid('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=bad').should.equal(false);
    URI.isValid('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&req-other=param')
                .should.equal(false);
    URI.isValid('flocoin:?r=https%3A%2F%2Ftest.bitpay.com%2Fi%2F6DKgf8cnJC388irbXk5hHu')
                .should.equal(false);
  });
  ...
  it('do not need new keyword', function() {
    var uri = URI('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
    uri.should.be.instanceof(URI);
  });

  describe('instantiation from flocoin uri', function() {
    /* jshint maxstatements: 25 */
    var uri;

    it('parses address', function() {
      uri = new URI('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
      uri.address.should.be.instanceof(bitcore.Address);
      uri.network.should.equal(Networks.livenet);
    });

    it('parses amount', function() {
      uri = URI.fromString('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=123.22');
    ...
    it('parses a testnet address', function() {
      uri = new URI('flocoin:mkYY5NRvikVBY1EPtaq9fAFgquesdjqECw');
      uri.address.should.be.instanceof(bitcore.Address);
      uri.network.should.equal(Networks.testnet);
    });

    it('stores unknown parameters as "extras"', function() {
      uri = new URI('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&other=param');
      uri.address.should.be.instanceof(bitcore.Address);
    ...
    it('throws error when a required feature is not supported', function() {
      (function() {
        return new URI('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&other=param&req-required=param');
      }).should.throw(Error);
    });
  ...
  it('should support double slash scheme', function() {
    var uri = new URI('flocoin://LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
    uri.address.toString().should.equal('LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
  });

  it('should input/output String', function() {
    var str = 'flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?' +
  ...
  it('should support numeric amounts', function() {
    var uri = new URI('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=12.10001');
  ...
  it('should generate a valid URI', function() {
    new URI({
      ...
      'flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3'
    );
    ...
    new URI({
      ...
      'flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.10001&message=Hello%20World&something=else'
    );
  ...
  it('should be case insensitive to protocol', function() {
    ...
    var uri2 = new URI('flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');

    uri1.address.toString().should.equal(uri2.address.toString());
  });

  it('writes correctly the "r" parameter on string serialization', function() {
    var originalString = 'flocoin:mmrqEBJxUCf42vdb3oozZtyz5mKr3Vb2Em?amount=0.1&' +
  ...
  it('displays nicely on the console (#inspect)', function() {
    var uri = 'flocoin:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3';
