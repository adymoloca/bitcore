...
Transaction.MAX_MONEY = 84000000 * 1e8; // Flocoin has 84M coins
...
Transaction.FEE_PER_KB = 100000; // Flocoin default fees is 0.001 LTC
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' Use Transaction#uncheckedSerialize if you want to skip security checks. ' +
      'See http://flocore.io/guide/transaction.html#Serialization for more info.';
