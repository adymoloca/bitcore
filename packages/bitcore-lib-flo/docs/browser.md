...
The easiest and recommended way to use them, is via [Bower](http://bower.io/), a browser package manager, and get the release bundles. For example, when building an app that uses `flocore` and `bitcore-mnemonic`, you do:
...
```sh
browserify --require ./index.js:bitcore-mnemonic --external flocore-lib | uglifyjs > bitcore-mnemonic.min.js
```
