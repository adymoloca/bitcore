...
Flocoin is a powerful new peer-to-peer platform for the next generation of financial technology. The decentralized nature of the Flocoin network allows for highly resilient flocoin infrastructure, and the developer community needs reliable, open-source tools to implement flocoin apps and services. Flocore provides a reliable API for JavaScript apps that need to interface with Flocoin.
...
* [Acknowledging and Requesting Payments: Flocoin URIs](uri.md)
...
* [Peer to Peer Networking](https://github.com/flocoin-project/flocore-p2p)
...
* [Signed Messages](https://github.com/flocoin-project/flocore-message)
